...
With this method, we structure risks as a :doc:`scenario </risk/scenarios>`, which will look similar to the examples below. Then, we :doc:`forecast </estimation/measurement>` the values associated with them. If these decisions are important, in increase the :doc:`rigor </enterprise/rigor>` involved with the process. `
